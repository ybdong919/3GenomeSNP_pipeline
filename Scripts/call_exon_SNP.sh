...
mv Clean_SNP_Genotypes.txt ./Output_results/NE_clean_SNP_genotypes.txt
mv Clean_SNP_hap.txt ./Output_results/NE_clean_SNP_hap.txt
mv All_SNP_Genotypes.txt ./Output_results/NE_SNP_genotypes.txt
mv All_SNP_hap.txt ./Output_results/NE_SNP_hap.txt
